...
quiver3(H(1,4,i), H(2,4,i), H(3,4,i), -H(1,2,i), -H(2,2,i), -H(3,2,i), 0, 'linewidth', 4, 'color', 'g'); %  fibula do pe
quiver3(H(1,4,i), H(2,4,i), H(3,4,i), H(1,3,i), H(2,3,i), H(3,3,i), 0, 'linewidth', 4, 'color', 'r'); % dedao do pe
end
