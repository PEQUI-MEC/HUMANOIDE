function DH = DH_parameters(array_12_angulos)
    %DH_PARAMETER retorna uma matriz 16x4 com os parametros de Denavit Hatenberg
    %Rot(z,theta) Trans(z,d) Trans(x,a) Rot(z,alpha)
    %Os frames junto com a tabela estao no diagrama na pasta do codigo
    df = 2; % altura do umbigo ate a quadril
    af = 3.7; % distancia do meio da quadril ate a junta do quadril
    a3 = 9.3; % tamanho da coxa
    a4 = a3;
    a9 = a3;
    a10= a4;
    de = 3.35; % altura da sola do pe ao calcanhar
    dd = de;
